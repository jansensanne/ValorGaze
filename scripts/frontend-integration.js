 ...
 * This file demonstrates how to integrate Valorgaze with a web frontend
 */

// For React/Vue/Angular applications
export class ValorgazeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ValorgazeClient(provider, contractAddress);
